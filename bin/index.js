...
contacts
  .command("export")
  .description("Exports contacts for a given account. Note that this does not include 'other' or 'directory' contacts.")
  .option(
    "-a, --account <account>",
...
contactGroups
  ...
  utlis.command("summarize-data")
  .description("Summarize the data obtained from the export command. The file must be a valid JSON file.")
